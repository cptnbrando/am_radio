...
// All of this is his, I just changed it a bit for Angular (and added lots of semicolons lol)
// Parsing through that massive Spotify audio analytics data terrified me and I was lost on where to start
// Zach was the light at the end of my tunnel. Much, much, much love to him <3
...
export default class Sketch {
    ...
    constructor(main?, container?, width?, height?, hidpi?, fill?)
    {
        if(typeof main != 'undefined') this.main = main;
        ...
        if(typeof hidpi != 'undefined') this.hidpi = hidpi;
